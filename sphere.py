...
class SphereMaker(ModelMaker):
    ...
    def generate(self):
        ...
        if inner_radius:
            ...
            inner_delta_angle_v = (
                pi - inner_bottom_angle - inner_top_angle) / segs_v
            ...
            if segs_bc and -radius < z < radius:
                ...
                for i in range(segs_h + 1):
                    ...
                    angle_h = delta_angle_h * i + \
                        (0. if inverted else slice_radians)
                    c = cos(angle_h)
                ...
                for i in range(1, segs_bc):
                    ...
                    for j in range(segs_h):
                        ...
                        vi4 = vi1 + 1
                        indices.extend(
                            (vi1, vi2, vi4) if inverted else (vi1, vi2, vi3))
                        indices.extend(
                            (vi2, vi3, vi4) if inverted else (vi1, vi3, vi4))
        ...
        if bottom_clip > -1.:
            ...
            for i in range(0, segs_h * f, f):
                ...
                vi4 = vi3 + 1
                indices.extend(
                    (vi1, vi4, vi3) if inverted else (vi1, vi2, vi3))
                indices.extend(
                    (vi1, vi2, vi4) if inverted else (vi2, vi4, vi3))
        ...
        if top_clip < 1.:
            ...
            for i in range(0, segs_h * f, f):
                ...
                indices.extend(
                    (vi1, vi2, vi4) if inverted else (vi1, vi2, vi3))
                indices.extend(
                    (vi1, vi4, vi3) if inverted else (vi2, vi4, vi3))
            ...
            if segs_tc and -radius < z < radius:
                ...
                for i in range(1, segs_tc):
                    ...
                    for j in range(segs_h):
                        ...
                        vi4 = vi1 + 1
                        indices.extend(
                            (vi1, vi3, vi2) if inverted else (vi1, vi4, vi2))
                        indices.extend(
                            (vi1, vi4, vi3) if inverted else (vi4, vi3, vi2))
            ...
            for cap_id in ("start", "end"):
                ...
                for i in range(segs_sc):
                    ...
                    if i == 0 and not inner_radius:
                        ...
                        n = 0 + (1 if bottom_clip > -1. else 0) + \
                            (1 if top_clip < 1. else 0)
                        ...
                        for j in range(segs_v + n):
                            ...
                            if cap_id == "start":
                                indices.extend(
                                    (vi1, vi2, vi3) if inverted else (vi1, vi3, vi2))
                            else:
                                indices.extend(
                                    (vi1, vi3, vi2) if inverted else (vi1, vi2, vi3))
                        ...
                        for j in range(0 if inner_radius else 1, segs_v + n):
                            ...
                            if cap_id == "start":
                                indices.extend(
                                    (vi1, vi4, vi2) if inverted else (vi1, vi2, vi4))
                                indices.extend(
                                    (vi2, vi4, vi3) if inverted else (vi2, vi3, vi4))
                            else:
                                indices.extend(
                                    (vi1, vi2, vi4) if inverted else (vi1, vi4, vi2))
                                indices.extend(
                                    (vi2, vi3, vi4) if inverted else (vi2, vi4, vi3))

                    n = 1 + (1 if bottom_clip > -1. else 0) + \
                        (1 if top_clip < 1. else 0)
        ...
        if inner_radius:
            ...
            tris_prim.offset_vertices(
                old_vert_count, old_row_count, new_row_count)
            ...
            vertex_data = GeomVertexData(
                "sphere_data", vertex_format, Geom.UH_static)
